 ...
 * convention posée en HEP-34. Déclenchée **une fois par jour** par le cron
 * Vercel (cf. `vercel.ts`, qui explique pourquoi pas davantage).
 *
 ...
 *
 * D'où la cadence quotidienne : rater une exécution ne casse rien de visible.
 * Le journal des mouvements accumule simplement des `RESERVE` sans `RELEASE`,
 * et la question « pourquoi ce produit paraissait-il indisponible mardi ? »
 * devient plus difficile à instruire. Ces deux motifs sont exclus de
 * `stockFromMovements` : l'invariant de cohérence du stock (HEP-41) n'est pas
 * affecté.
 *
